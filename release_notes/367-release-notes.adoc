...
[id="log4shell-policy"]
==== Log4Shell policy
{product-title} 3.67.2 includes a new policy called *Log4Shell: CVE-2021-44228 - log4j Remote Code Execution vulnerability* which creates alerts for deployments that have images containing the Log4Shell vulnerability (CVE-2021-44228).
...
* *ROX-8702*: In {product-title-short} 3.67.0, when using OpenShift OAuth, users' e-mails were displayed incorrectly as their username if an e-mail was unavailable. This issue has been fixed.
